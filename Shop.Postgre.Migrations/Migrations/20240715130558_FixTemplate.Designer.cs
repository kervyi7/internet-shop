...
namespace Shop.Postgre.Migrations.Migrations
{
    ...
    [Migration("20240715130558_FixTemplate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Database.Models.Category", b =>
                {
                    ...
                    b.HasOne("Shop.Database.Models.PropertyTemplate", "PropertyTemplate")
                        .WithOne("Category")
                        .HasForeignKey("Shop.Database.Models.Category", "PropertyTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shop.Database.Models.PropertyTemplate", b =>
                {
                    b.OwnsOne("Shop.Database.Models.Jsons.TemplateExtension", "Extension", b1 =>
                        {
                            b1.Property<int>("PropertyTemplateId")
                                .HasColumnType("integer");

                            b1.HasKey("PropertyTemplateId");

                            b1.ToTable("PropertyTemplate", "public");
